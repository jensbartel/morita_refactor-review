...
const Part02 = () => {
    return (
        <>
            ...
            <Fade>
                <TextLeftImageRight text={workSelection3} item={essay15} />
            </Fade>
            ...
            <div className='listcontainer'>
                <a href='http://exh.shibunkaku.co.jp/MoritaShiryu_ListofWorks.pdf' download >
                    <u>Download work list</u>
                </a>
            </div>
            ...
            <div className='theVideo'>
                <Iframe
                    className='iframe'
                    url='https://player.vimeo.com/video/546329551?autoplay=0&title=0&byline=0&portrait=0'
                    frameborder='0'
